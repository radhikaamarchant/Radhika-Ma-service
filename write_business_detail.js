import fs from 'fs';
fs.writeFileSync('src/components/BusinessDetail.tsx', `import React, { useState, useRef, useEffect } from "react";
...
export default function BusinessDetail({
  ...
  return (
    <div className="bg-[#F8F9FA] min-h-screen -mx-3 md:mx-0 px-0 md:px-0 md:rounded-lg animate-fade-in relative font-sans text-[#444444]">
      {/* Header */}
      ...
      {currentView === "menu" && (
        <div className="bg-white">
          <div className="px-5 py-6 flex justify-between items-center border-b border-gray-100">
            <div>
              <h2 className="text-[18px] md:text-[20px] font-normal text-[#444444] mb-1 tracking-wide">{business.name || "Business Name"}</h2>
              <p className="text-[12px] md:text-[13px] text-[#9EA1A6] uppercase tracking-widest">{business.ownerName || "Owner Name"}</p>
      ...
      {currentView === "funds" && (
        <div className="p-4 md:p-6 bg-[#F8F9FA]">
          <div className="bg-white rounded shadow-sm border border-gray-200 p-5 mb-5 text-center">
            ...
            <p className="text-[26px] md:text-[32px] font-medium text-[#1976D2] tracking-wide mb-2">
          ...
          <div className="grid grid-cols-1 gap-4 mb-6">
            <div className="bg-white rounded p-4 border border-gray-200 shadow-sm">
               <div className="space-y-4">
                  ...
                  <button onClick={handleSaveFunds} className="w-full bg-[#4CAF50] text-white py-3 rounded text-[14px] md:text-[15px] font-medium mt-2">
                    + Add funds
                  </button>
               </div>
            </div>
      ...
      {currentView === "profile" && (
        <div className="p-4 md:p-6 bg-white min-h-[calc(100vh-60px)] space-y-5">
           <div>
      ...
      {currentView === "investors" && (
        <div className="bg-[#F8F9FA] min-h-[calc(100vh-60px)]">
      ...
      {currentView === "bank" && (
        <div className="bg-white min-h-[calc(100vh-60px)] p-4 md:p-6 space-y-5">
      ...
      {currentView === "registration" && (
        <div className="bg-white min-h-[calc(100vh-60px)] p-4 md:p-6 space-y-5">
           ...
           <div className="border-b border-gray-100 pb-4">
             ...
             <p className="text-[15px] md:text-[16px] font-medium text-[#1976D2]">{formatINR(business.registrationCommissionPaid + business.taxPaid)}</p>
           </div>
        </div>
      )}
